...
-- The raw password is "123chicken123", uses MD5 scheme and salt "123salt"
INSERT INTO User (login_id, password, name, email, address, phone, city_code, salt, is_admin) VALUES ('AdminDoe', 'ad5e7f9c0578844f20adbc2c757cb59e', 'John Doe', 'john.doe@clothscs.com', '1234 Street St', '6471112222', '647', '123salt', 1);
INSERT INTO User (login_id, password, name, email, address, phone, city_code, salt) VALUES ('UserDoe', 'ad5e7f9c0578844f20adbc2c757cb59e', 'Jane Doe', 'jane.doe123@gmail.com', '4321 Avenue Av', '4162221111', '416', '123salt');

INSERT INTO Shopping (store_code, total_price) VALUES ('1', 9);
INSERT INTO Shopping (store_code, total_price) VALUES ('2', 7);

INSERT INTO Truck (truck_code, availability_code) VALUES ('X123', '789');
INSERT INTO Truck (truck_code, availability_code) VALUES ('Y123', '678');

INSERT INTO Trip (source_code, destination_code, distance, truck_id, price) VALUES ('123', '456', '10km', 1, "5.00");
INSERT INTO Trip (source_code, destination_code, distance, truck_id, price) VALUES ('123', '456', '20km', 2, "10.00");
