...
<form style="display:none" id="form1" action="validate-select.php" method="post">
...
<form style="display:none" id="form2" action="validate-select.php" method="post">
    <div class="sign-wrapper">
        <div class="sign-container">
...
<form style="display:none" id="form3" action="validate-select.php" method="post">
    <div class="sign-wrapper">
        <div class="sign-container">
...
<form style="display:none" id="form4" action="validate-select.php" method="post">
    <div class="sign-wrapper">
        <div class="sign-container">
...
<form style="display:none" id="form5" action="validate-select.php" method="post">
    <div class="sign-wrapper">
        <div class="sign-container">
            <div id="shoppingTableFields">
...
<form style="display:none" id="form6" action="validate-select.php" method="post">
    <div class="sign-wrapper">
        <div class="sign-container">
...
<form style="display:none" id="form7" action="validate-select.php" method="post">
    <div class="sign-wrapper">
        <div class="sign-container">
            <div id="shoppingTableFields">
