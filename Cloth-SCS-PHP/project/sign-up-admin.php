...
<form action="validate-sign-up.php" method="post">
    <div class="sign-wrapper">
        <div class="sign-container">
            <h1>Admin Sign Up</h1>
            <p>
                Register an account to gain administrator rights. On submit, you
                will have to answer the correct <b>admin code</b>.
            </p>
            ...
            <div class="sign-multiple-column sign-end">
                <input type="submit" value="Sign Up" onclick="return verifyAdminCode();">
                <a href="./sign-up.php">For Users</a>
            </div>
        </div>
    </div>
</form>
